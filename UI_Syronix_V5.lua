...
function UILibrary.Main(PrjName,HideKey)
	...
	function Tabs.Loader()
		...
		for i = 1,4 do
			...
			Circle.BackgroundColor3 = Color3.fromRGB(255,140,140)
	...
	function Tabs.NewTab(TabName)
		...
		for index,page in next,Pages:GetChildren() do
			if page.Name ~= "UIPageLayout" and (page.Name == Frame.Name and index == 2) then
				...
				TweenService:Create(TabButton,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255,140,140)}):Play()	
		...
		function ElementsLib.NewSection(SectionName)
			...
			function InSection.NewToggle(ToggleText,UserFunc,defbool)
				...
				Toggle.Text = ""
				Toggle.TextColor3 = Color3.fromRGB(255,140,140)
				...
				ToggleLabel.BorderColor3 = Color3.fromRGB(255,140,140)
				...
				Checker.BackgroundColor3 = Color3.fromRGB(255,140,140)
			...
			function InSection.NewSlider(SliderText,min,max,precise,UserFunc,defvalue)
				...
				SliderLabel.BorderColor3 = Color3.fromRGB(255,140,140)
				...
				Progress.BackgroundColor3 = Color3.fromRGB(255,140,140)
			...
			function InSection.NewDropdown(placeholder,Selectables,func,IsMulti)
				...
				local function NewSelectable(Text,val)
					...
					ChoosedCircle.BackgroundColor3 = Color3.fromRGB(255,140,140)
					...
					InnerCircle.BackgroundColor3 = Color3.fromRGB(255,140,140)
...
TextBox.FocusLost:Connect(function() 
			...
			function InSection.NewButton(btnText,func)
				...
				Button.MouseButton1Down:Connect(function()
					TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255,140,140)}):Play()
				end)
